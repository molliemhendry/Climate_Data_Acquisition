---
title: "Climate Data Acquisition"
author: "Matthew Ross"
date: "2024-04-15"
...
A key part of many environmental prediction and analysis pipelines is using
climate data to drive predictions. The purpose of this workflow is to make this 
as easy as possible. 

## GLDAS

Most of this code comes from [B Steele](https://github.com/rossyndicate/ROSS_RS_mini_tools/blob/main/LDAS_data_rods/Download_Summarize_GLDAS.Rmd). 
...
GLDAS-2.0: January 1, 1948 -- December 31, 2014
GLDAS-2.1: January 1, 2000 -- Present
...
```{r}
ggplot(fiveday, aes(x = max_wind_5,
                    y = precip_5)) + 
  geom_point()


ggplot(fiveday, aes(x = solrad_5,
                    y = precip_5)) + 
  geom_point()
...
ggplot(GLDAS_summary, aes(x = mean_wind_5,
                          y = mean_wind_7)) + 
  geom_point()
